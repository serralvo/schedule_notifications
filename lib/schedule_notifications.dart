...
class ScheduleNotifications {
  ...
  static Future<Null> scheduleAndroid(String text, DateTime when, List<int> repeatAt, int icon) {
    return _channel.invokeMethod('scheduleAndroidNotification', [text, when.toString(), repeatAt, icon]);
  }
